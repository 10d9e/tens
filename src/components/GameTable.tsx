        ...
        <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-900">
            ...
            <div className="flex justify-between items-center p-3 bg-white/10 backdrop-blur-md border-b border-white/20">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* Last Round Button - rendered in portal to ensure it's above bid interface */}
                    {currentGame.phase !== 'finished' && currentGame.rounds.length > 0 && createPortal(
                        <button
            ...
            {/* Last Round Viewer */}
            {showLastRoundViewer && currentGame && (
                <LastRoundViewer
